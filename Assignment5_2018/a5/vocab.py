...
class VocabEntry(object):
    ...
    def words2charindices(self, sents):
        ...
        return [[[sow, *[self.char2id[char] for char in word], eow] for word in sen] for sen in sents]
    ...
    def to_input_tensor_char(self, sents: List[List[str]], device: torch.device) -> torch.Tensor:
        ...
        # assert sents_var.shape==(max_sentence_length, batch_size, max_word_length)  
