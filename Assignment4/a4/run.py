...
def train(args: Dict):
    ...
    # model.parameter
    # 1. extract the child of 'Module' ex. Linear, Embedding
    # 2. if they have vector? then return name, vector
    ...
    while True:
        ...
        for src_sents, tgt_sents in batch_iter(train_data, batch_size=train_batch_size, shuffle=True):
            ...
            optimizer.zero_grad() # initization: params set to 0
            ...
            # optimizer update and return loss
            optimizer.step()
