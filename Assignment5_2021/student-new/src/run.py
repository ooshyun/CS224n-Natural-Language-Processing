...
# student-new folder path
default_path = ''
for key in args.__dict__.keys():
    if 'path' in key and isinstance(args.__dict__[key], str):
        print(args.__dict__[key])
        args.__dict__[key] = default_path + args.__dict__[key]
...
if args.variant == 'vanilla':
    # TODO [part c]: Make some model which has non fine training here
    model = GPT(mconf)
    pass 
